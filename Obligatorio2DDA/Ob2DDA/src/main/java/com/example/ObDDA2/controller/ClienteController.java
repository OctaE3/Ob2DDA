...
public class ClienteController {
  ...
  public String guardarCliente(@Validated @ModelAttribute("cliente") Cliente cliente, BindingResult bindingResult,
    ...
    try {
      ...
      redirect.addFlashAttribute("msgExito", "El cliente fue agregado con éxito");
      return "redirect:/listarClientes";

    } catch (Exception e) {
      System.out.println(e);
      redirect.addFlashAttribute("msgError", "Ocurrió un error, no se logro agregar, compruebe que los datos sean correctos");
      return "redirect:/listarClientes";
    }
  }
  ...
  public String modificarCliente(@PathVariable(value = "ci") Long ci, @ModelAttribute("cliente") Cliente cliente,
    ...
    try {
      ...
      System.out.println(e);
      redirect.addFlashAttribute("msgError", "Ocurrió un error, no se logró modificar, compruebe que los datos sean correctos");
      return "redirect:/listarClientes";
    }
  }

  @GetMapping(value = "/cargarCliente/{ci}")
  public String cargarCliente(@PathVariable(value = "ci") Long ci, Model modelo, RedirectAttributes redirect) {
    try {
      ...
      redirect.addFlashAttribute("msgError", "Ocurrió un error, no se logró cargar el cliente seleccionar verifique que el cliente exista.");
      return "redirect:/listarClientes";
    }
  }

  @GetMapping(value = "/cargarClienteAsignar/{ci}")
  public String cargarClienteAsignar(@PathVariable(value = "ci") Long ci, Model modelo, RedirectAttributes redirect) {
    try{
      Cliente cliente = clienteServiceImpl.findById(ci);
    ...
    return "asignar_viajes_clientes";
      ...
      redirect.addFlashAttribute("msgError", "Ocurrió un error, no se logro cargar el cliente seleccionado verifique que el cliente exista.");
      return "redirect:/listarClientes";
    }
  }

  @GetMapping(value = "/eliminarCliente/{ci}")
  public String eliminarCliente(@PathVariable Long ci, RedirectAttributes redirect) {
    try {
      ...
      redirect.addFlashAttribute("msgError", "Ocurrió un error, no se logró eliminar el cliente seleccionado verifique que el cliente exista.");
      return "redirect:/listarClientes";
    }
  }
}
